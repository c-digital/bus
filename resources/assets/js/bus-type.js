...
for (i = 0; i <= remainder; i++) {
    // $("#teslayout").append("<img class='img' width='50px' height='50px' src='/resources/assets/img/seat.png'/>");
}
...
$container.append($("<tr/>").append(
   $("<td/>").html("<img class='img' width='50px' height='50px' src='/resources/assets/img/seat.png' onerror=this.src='..//resources/assets/img/seat.png' title='"+char+1+"' />"),
   $("<td/>").html("<img class='img' width='50px' height='50px' src='/resources/assets/img/seat.png' onerror=this.src='..//resources/assets/img/seat.png' title='"+char+2+"'/>"),
   $("<td/>").html("<div class='"+lastclass+"' title='"+char+"M'></div>"),
   $("<td/>").html("<img class='img' onerror=this.src='..//resources/assets/img/seat.png' width='50px' height='50px' src='/resources/assets/img/seat.png'  title='"+char+3+"'/>"),
   $("<td/>").html("<img class='img' onerror=this.src='..//resources/assets/img/seat.png' width='50px' height='50px' src='/resources/assets/img/seat.png'  title='"+char+4+"'/>"),
...
if(lasseat=='last' && num==testn/3){
  ...
  $("<td/>").html("<div class='"+lastclass+"' title='"+char+"M'>123</div>"),
  $("<td/>").html("<img class='img' width='50px' height='50px' src='/resources/assets/img/seat.png' onerror=this.src='..//resources/assets/img/seat.png' title='"+char+3+"'/>"),
    ...
    options =chair;
      ...
      if(lasseat=='last' && num==testn/5){
          ...
          lastclass='midlesp';
                    ...
                    $("<td/>").html("<img class='img' width='50px' height='50px' src='/resources/assets/img/seat.png' onerror=this.src='..//resources/assets/img/seat.png' title='"+char+4+"'/>"),
                     $("<td/>").html("<img class='img' width='50px' height='50px' src='/resources/assets/img/seat.png' onerror=this.src='..//resources/assets/img/seat.png' title='"+char+5+"'/>"),
